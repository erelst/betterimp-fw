...
5. **ponytail & ponytail-audit:** Enforce minimal coding. Use `/ponytail-audit` to scan for code bloat, dead code, and speculative abstractions, ranking findings by lines of code to cut.
